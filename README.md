...
[![My Skills](https://skillicons.dev/icons?i=python,java,cpp,ts,r,bash,sklearn,pytorch,tensorflow,aws,azure,docker,terraform,kubernetes,postgresql,mongodb,linux,vscode,pycharm,idea,clion,anaconda,)](https://skillicons.dev)
